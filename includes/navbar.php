  ...
  <div class="container-fluid px-4">
    ...
    <div class="collapse navbar-collapse" id="mainNavbar">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item"><a class="nav-link" href="/nomina/pages/unid_curricular.php">📘 Unid Curriculares</a></li>
        <li class="nav-item"><a class="nav-link" href="/nomina/pages/catalogo_unidades.php">📚 Catálogo de Unid</a></li>
